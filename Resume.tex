...
\SummaryEntry{%
Ben Liu is focusing on web apps developing these 5 years. He worked in JavaScript / ReactJS \& NodeJS for 3 \& 1.5 years respectively.
...
\begin{itemize}
	\item {Led 3 Devs and 1 DevOps to build an API service for 1000+ online mobile users in 4 weeks.}
	\item {Solved 3rd party API issues across the Ops team and Devs team on Prod in one day.}
	...
	\item {Resolved the browser crashed issue by throttling when receiving 150+/s transactions stream.}
