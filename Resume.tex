...
He worked in JavaScript / ReactJS and NodeJS for 3.5 and 2 years respectively.
...
\SkillsEntry{Databases} {Redis, Mongo, Firebase, PostgreSQL}
...
\begin{itemize}
	\item {Designed and built a chat bot web application for 1000+ end users in 3 weeks.}
	\item {Led 2 Devs to build a serverless API to integrate applicant tracking system in 2 weeks.}
